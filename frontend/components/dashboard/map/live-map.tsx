...
export default function LiveMap() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-lg border">
      ...
      <div className="relative isolate flex-1 [&_.leaflet-tile-pane]:brightness-[0.85] [&_.leaflet-tile-pane]:contrast-[0.9] [&_.leaflet-tile-pane]:hue-rotate-180 [&_.leaflet-tile-pane]:invert">
